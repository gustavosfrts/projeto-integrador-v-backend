...
class produtoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        ImagemProduto::create([
            'caminho' => 'http://18.228.214.223/storage/products/kailani.png',
            'produto_id' => 1,
        ]);
        ...
        ImagemProduto::create([
            'caminho' => 'http://18.228.214.223/storage/products/narciso.png',
            'produto_id' => 2,
        ]);
        ...
        ImagemProduto::create([
            'caminho' => 'http://18.228.214.223/storage/products/helios.png',
            'produto_id' => 3,
        ]);
    }
}
